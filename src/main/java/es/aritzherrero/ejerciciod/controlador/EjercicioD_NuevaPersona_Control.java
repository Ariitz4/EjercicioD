package es.aritzherrero.ejerciciod.controlador;

import es.aritzherrero.ejerciciod.modelo.Persona;
 ...
 */
public class EjercicioD_NuevaPersona_Control {
    ...
    void guardarPersona(ActionEvent event) {
        ...
        if (!errorMessage.isEmpty()) {
            EjercicioD_Principal_Control.ventanaAlerta("E", errorMessage);
            return;
        }
        ...
        try {
            ...
            if (EjercicioD_Principal_Control.listaPersonas.contains(nuevaPersona)) {
                EjercicioD_Principal_Control.ventanaAlerta("E", "La persona ya existe");
            } else {
                // Añade la nueva persona a la lista y muestra un mensaje de éxito.
                EjercicioD_Principal_Control.listaPersonas.add(nuevaPersona);
                EjercicioD_Principal_Control.ventanaAlerta("C", "Persona añadida correctamente");
            ...
            EjercicioD_Principal_Control.ventanaAlerta("E", "El valor de edad debe ser un número mayor que cero");
        }
    }
